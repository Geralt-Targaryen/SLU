...
from utils.example_bert_pretrain import Example_bert_pretrain
from utils.batch_bert_pretrain import from_example_list_pretrain
from model.roberta_tagging_pretrain import SLUTagging_bert
...
Example_bert_pretrain.configuration(args.dataroot, model=args.model_name_or_path, train_path=train_path)

train_dataset = Example_bert.load_dataset(train_path)               # list[Example]
dev_dataset = Example_bert.load_dataset(dev_path)
pretrain_dataset = Example_bert_pretrain.load_dataset(train_path)
...
args.pretrain_vocab_size = Example_bert_pretrain.word_vocab.vocab_size
