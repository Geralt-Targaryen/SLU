...
def add_argument_base(arg_parser):
    ...
    arg_parser.add_argument('--checkpoint', type=str, default='model.bin', help='checkpoint for evaluation on dev set')
    #### Training Hyperparams ####
    arg_parser.add_argument('--batch_size', default=32, type=int, help='Batch size')
    arg_parser.add_argument('--lr', type=float, default=1e-3, help='learning rate')
    arg_parser.add_argument('--max_epoch', type=int, default=100, help='terminate after maximum epochs')
    #### Common Encoder Hyperparams ####
    arg_parser.add_argument('--model_name_or_path', default='hfl/chinese-roberta-wwm-ext', choices=['hfl/chinese-roberta-wwm-ext', 'xlm-roberta-base'], help='pretrained LM')
    ...
    arg_parser.add_argument('--hidden_size', default=512, type=int, help='hidden size for lstm')
